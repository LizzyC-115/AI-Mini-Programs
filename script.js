...
const URL = "https://teachablemachine.withgoogle.com/models/xnf9ERDJF/";
...
// Call the function to simulate pressing the right arrow key

// Call the function to simulate pressing the left arrow key

// Call the function to simulate pressing the up arrow key

// Call the function to simulate pressing the down arrow key
...
for (let i = 0; i < maxPredictions; i++) {
    ...
    if (prediction[0].probability.toFixed(2) >= 0.75) {
      goBackwards();
     // const audio = new Audio("wakeupalarm.mp3");
      //audio.play();
      //pressArrowLeft();
    }
